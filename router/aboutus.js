...
router.put('/Aboutusupdate/:Id', upload.fields([{ name: 'bgimg', maxCount: 1 },
{ name: 'firstimg', maxCount: 1 }, { name: 'secondimg', maxCount: 1 }, { name: 'ceoimg', maxCount: 1 }]), async (req, res) => {
    let { BGTitle, BGSubTitle, BGDescription,  FirstTitle, FirstSubTitle, FirstDescription,
        SecondTitle, SecondSubTitle, SecondDescription,
        CeoDeatils,
        ShortDescription,
