...
const storage = multer.diskStorage({
  ...
  router.post('/addevents',upload.array("EventImage"), async (req, res) => {
    try {
        const { EventName, EventShortdescription, EventOrganizer,EventType ,Eventdescription, EventPrice, venueId, eventDates,} = req.body;
    ...
    router.get('/getOneEvent/:id', async (req, res) => {
      ...
      try {
          ...
          console.log("Event information for ID", EventId, ":", Events);
